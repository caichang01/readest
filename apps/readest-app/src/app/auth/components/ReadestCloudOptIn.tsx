 ...
 *
 * Lets users choose account-level library sync before signing in. Third-party
 * providers in this fork never require an account or membership; signing in
 * for other account data must not force an unwanted library upload.
 *
