 ...
 * stock LocalSend app) always confirms no matter what.
 */
export function canAutoAccept(sender: { fingerprint: string; certVerified: boolean }): boolean {
  return sender.certVerified && isPairedDevice(sender.fingerprint);
}
